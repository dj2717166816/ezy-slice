...
public class RuntimeShatterExample : MonoBehaviour {
    ...
    public GameObject[] ShatterObject(GameObject obj, Material crossSectionMaterial = null) {
        return obj.SliceInstantiate(new EzySlice.Plane(obj.transform.InverseTransformPoint(new Vector3 (0f,0f,0f)), obj.transform.InverseTransformDirection(new Vector3 (0f,1f,0f))),//使用世界坐标中的法向量
